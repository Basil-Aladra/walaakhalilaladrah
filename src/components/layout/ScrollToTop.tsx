...
export default function ScrollToTop() {
  ...
  return (
    ...
    >
      {/* 1. Floating WhatsApp Button with Phone Number */}
      <motion.a
        ...
        className="group relative flex items-center justify-center w-12 h-12 sm:w-13 sm:h-13 bg-[#25D366] hover:bg-[#20ba5a] text-white shadow-2xl hover:shadow-green-500/30 transition-all duration-300 focus:outline-none rounded-full"
      >
        {/* Subtle Ambient Pulse Ring */}
        <span className="absolute inset-0 rounded-full bg-[#25D366] opacity-30 animate-ping pointer-events-none" />

        {/* Custom High-Res WhatsApp SVG */}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 48 48"
          className="w-7 h-7 sm:w-8 sm:h-8 relative z-10 transition-transform duration-300 group-hover:scale-110 drop-shadow"
        >
          <path
            fill="#fff"
        ...
        {/* Hover Tooltip displaying WhatsApp Number */}
        <span
          className={`absolute ${
            isRTL ? "right-full mr-3.5" : "left-full ml-3.5"
          } px-3 py-1.5 bg-[#1B1714] text-white text-xs font-mono tracking-wider pointer-events-none opacity-0 group-hover:opacity-100 transition-all duration-200 whitespace-nowrap shadow-xl border border-white/10 flex items-center gap-2 rounded-sm`}
        >
        ...
        {isVisible && (
          ...
          >
            ...
            <span
              className={`absolute ${
                isRTL ? "right-full mr-3.5" : "left-full ml-3.5"
              } px-2.5 py-1 bg-[#1B1714] text-white text-[10px] font-mono uppercase tracking-widest pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap shadow-md border border-white/10`}
            >
