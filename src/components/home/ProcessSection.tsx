      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="text-base sm:text-lg text-secondary font-light max-w-2xl mt-4">
            A methodical four-stage workflow delivering architectural clarity, rigorous material selection, and faithful construction execution.
          </motion.p>
        </motion.div>
